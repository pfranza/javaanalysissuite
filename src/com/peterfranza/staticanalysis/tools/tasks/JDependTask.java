 ...
 * >http://www.clarkware.com/software/JDepend.html</a>.
 * 
...
public class JDependTask extends Task {
	 ...
	 * 
	 * <p>
	 * If the operation is running for more than this value, the jdepend will be
	 * canceled. (works only when in 'fork' mode).
	 * </p>
	 * 
	 * @param value
		...
		try {
			...
			if (patterns != null && patterns.length > 0) {
				if (SetFilter != null) {
					...
					try {
						Object o = PackageFilterC
						.newInstance(new Object[] { v });
	 ...
	 * 
	 * @param commandline
	 *            the commandline for forked jvm
	 * @param watchdog
	 *            the watchdog
	 * 
